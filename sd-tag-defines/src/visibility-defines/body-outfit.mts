...
const allBraColorVisibilities = {
  "aqua bra": preset.bra,
  "black bra": preset.bra,
  "blue bra": preset.bra,
  "brown bra": preset.bra,
  "green bra": preset.bra,
  "grey bra": preset.bra,
  "orange bra": preset.bra,
  "pink bra": preset.bra,
  "purple bra": preset.bra,
  "red bra": preset.bra,
  "white bra": preset.bra,
  "yellow bra": preset.bra,
} as const satisfies Partial<Record<BodyOutfitTag, Visibility>>;
...
const allDistinguishableOutfitVisibilities = {
  ...
  "body apron -> apron": preset.dress,
  "waist apron -> apron": preset.skirt,
  "frilled body apron -> frilled apron": preset.dress,
  "frilled waist apron -> frilled apron": preset.skirt,
  "aqua body apron -> aqua apron": preset.dress,
  "black body apron -> black apron": preset.dress,
  "blue body apron -> blue apron": preset.dress,
  "brown body apron -> brown apron": preset.dress,
  "green body apron -> green apron": preset.dress,
  "grey body apron -> grey apron": preset.dress,
  "orange body apron -> orange apron": preset.dress,
  "pink body apron -> pink apron": preset.dress,
  "purple body apron -> purple apron": preset.dress,
  "red body apron -> red apron": preset.dress,
  "white body apron -> white apron": preset.dress,
  "yellow body apron -> yellow apron": preset.dress,
  "aqua waist apron -> aqua apron": preset.skirt,
  "black waist apron -> black apron": preset.skirt,
  "blue waist apron -> blue apron": preset.skirt,
  "brown waist apron -> brown apron": preset.skirt,
  "green waist apron -> green apron": preset.skirt,
  "grey waist apron -> grey apron": preset.skirt,
  "orange waist apron -> orange apron": preset.skirt,
  "pink waist apron -> pink apron": preset.skirt,
  "purple waist apron -> purple apron": preset.skirt,
  ...
  "chest bow -> bow": preset.bowtie,
  "aqua chest bow -> aqua bow": preset.bowtie,
  "black chest bow -> black bow": preset.bowtie,
  "blue chest bow -> blue bow": preset.bowtie,
  "brown chest bow -> brown bow": preset.bowtie,
  "green chest bow -> green bow": preset.bowtie,
  "grey chest bow -> grey bow": preset.bowtie,
  "orange chest bow -> orange bow": preset.bowtie,
  "pink chest bow -> pink bow": preset.bowtie,
  "purple chest bow -> purple bow": preset.bowtie,
  "red chest bow -> red bow": preset.bowtie,
  "white chest bow -> white bow": preset.bowtie,
  "yellow chest bow -> yellow bow": preset.bowtie,
  "aqua waist ribbon -> aqua ribbon": preset.skirt,
  "black waist ribbon -> black ribbon": preset.skirt,
  "blue waist ribbon -> blue ribbon": preset.skirt,
  "brown waist ribbon -> brown ribbon": preset.skirt,
  "green waist ribbon -> green ribbon": preset.skirt,
  "grey waist ribbon -> grey ribbon": preset.skirt,
  "orange waist ribbon -> orange ribbon": preset.skirt,
  "pink waist ribbon -> pink ribbon": preset.skirt,
  "purple waist ribbon -> purple ribbon": preset.skirt,
  "red waist ribbon -> red ribbon": preset.skirt,
  "white waist ribbon -> white ribbon": preset.skirt,
  "yellow waist ribbon -> yellow ribbon": preset.skirt,
  "aqua short tail -> aqua tail": preset["short tail"],
  "black short tail -> black tail": preset["short tail"],
  "blue short tail -> blue tail": preset["short tail"],
  "brown short tail -> brown tail": preset["short tail"],
  "green short tail -> green tail": preset["short tail"],
  "grey short tail -> grey tail": preset["short tail"],
  "orange short tail -> orange tail": preset["short tail"],
  "pink short tail -> pink tail": preset["short tail"],
  "purple short tail -> purple tail": preset["short tail"],
  "red short tail -> red tail": preset["short tail"],
  "white short tail -> white tail": preset["short tail"],
  "yellow short tail -> yellow tail": preset["short tail"],
  "aqua long tail -> aqua tail": preset["long tail"],
  "black long tail -> black tail": preset["long tail"],
  "blue long tail -> blue tail": preset["long tail"],
  "brown long tail -> brown tail": preset["long tail"],
  "green long tail -> green tail": preset["long tail"],
  "grey long tail -> grey tail": preset["long tail"],
  "orange long tail -> orange tail": preset["long tail"],
  "pink long tail -> pink tail": preset["long tail"],
  "purple long tail -> purple tail": preset["long tail"],
  "red long tail -> red tail": preset["long tail"],
...
export const allBodyOutfitVisibilities = {
  ...
  "asymmetrical gloves": preset["elbow gloves"],
  ...
  "bow bikini": preset.dress,
  "bow skirt": preset.skirt,
  ...
  "camouflage": preset.dress, // TODO: Reconsider.
  "cape": preset.shirt,
  ...
  "frilled bra": preset.bra,
  "frilled camisole": preset.shirt,
  ...
  "highleg bikini": preset.panties,
  "hip vent": preset["side hip"],
  "homurabara academy school uniform": preset.all,
  "hood up": preset.hat,
  "hood": preset.hat,
  ...
  "micro shorts": preset.skirt,
  "microskirt": preset.skirt,
  ...
  "mismatched gloves": preset["elbow gloves"],
  ...
  "pinstripe jacket": preset.shirt,
  "pinstripe shirt": preset.shirt,
  "pinstripe skirt": preset.skirt,
  "pinstripe suit": preset.dress,
  "pirate": preset.all,
  ...
  "see-through shawl": preset["elbow gloves"],
  ...
  "shrug \\(clothing\\)": preset.shoulder,
  ...
  "stomach tattoo": preset.navel,
  "strap": preset.all,
  "strapless bikini": preset.shoulder,
  "strapless bra": preset.shoulder,
  "strapless dress": preset.shoulder,
  "strapless leotard": preset.shoulder,
  "strapless one-piece swimsuit": preset.shoulder,
  "striped bikini": preset.dress,
  "striped camisole": preset.shirt,
