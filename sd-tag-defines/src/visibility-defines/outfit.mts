...
const allHatColorVisibilities = {
  "aqua hat": preset.hat,
  "black hat": preset.hat,
  "blue hat": preset.hat,
  "brown hat": preset.hat,
  "green hat": preset.hat,
  "grey hat": preset.hat,
  "orange hat": preset.hat,
  "pink hat": preset.hat,
  "purple hat": preset.hat,
  "red hat": preset.hat,
  "white hat": preset.hat,
  "yellow hat": preset.hat,
} as const satisfies { [key in OutfitTag]?: Visibility };
...
export const allOutfitVisibilities = {
  ...
  "fur-trimmed headwear": preset.hat,
  ...
  "hair flower": preset.hat,
  "hair ornament": preset.hat,
