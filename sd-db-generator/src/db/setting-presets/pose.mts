...
export const posesPreset = {
  ...
  "bedroom-for-undressing": [
    { key: `standing-from-above-undressing-upper-body` },
    { key: `standing-from-above-undressing` },
    { key: `standing-from-below-undressing-upper-body` },
    { key: `standing-from-below-undressing` },
    { key: `standing-from-horizontal-undressing-upper-body` },
    { key: `standing-from-horizontal-undressing` },
  ],
